...
const About = () => {
  return (
    <section className='about h-screen flex items-center justify-start bg-cover bg-center text-amber-300 px-10' style={{backgroundImage:"url('/bagy2.jpg')"}}>
